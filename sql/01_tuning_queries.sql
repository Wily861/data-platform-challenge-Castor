...
-- Problema: EXTRACT(YEAR) impide el uso de índices (Sequential Scan)[cite: 18, 50].
...
-- Problema: LIKE con % inicial y SELECT * son ineficientes en 8M de filas[cite: 50, 64].
...
-- Problema: Subquery correlacionada ejecuta O(n^2), bloqueando el rendimiento[cite: 16, 76].
